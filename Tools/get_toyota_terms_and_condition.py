...
def get_toyota_terms_conditions(
    ...
    Args:
        model_of_interest (str, optional): Specific model to filter by (e.g., 'Prado', 'Land Cruiser')
        slug (str, optional): Slug identifier to filter by (e.g., 'Raize', 'land-cruiser')
    ...
    Examples:
        >>> get_toyota_terms_conditions(model_of_interest="Land Cruiser")
        {
            "status": "success",
            "count": 1,
            "terms_conditions": [...],
...
if __name__ == "__main__":
    # Test the tool
    print("Toyota Terms & Conditions (Land Cruiser):")
    result = get_toyota_terms_conditions(model_of_interest="Land Cruiser")
